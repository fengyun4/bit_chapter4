...
public class Solution2C1Activity extends AppCompatActivity {
    ...
    public void requestData(View view) {
        ...
        Call<List<Cat>> my_call=request.getCall();
        my_call.enqueue(new Callback<List<Cat>>() {
            @Override
...
//        //第二种写法
//        ICatService catRetrofit=retrofit.create(ICatService.class);
//        Call<List<Cat>> my_call_two=catRetrofit.randomCat(5);
//        my_call_two.enqueue(new Callback<List<Cat>>() {
//            @Override
//            public void onResponse(Call<List<Cat>> call, Response<List<Cat>> response) {
//                loadPics(response.body());
//                restoreBtn();
